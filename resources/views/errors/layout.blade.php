...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('storage/css/error.css') }}">
    ...
    <main>
        ...
        <div id="error-container">
            <div id="error-main-container">
                <img src="{{ asset('images/placeholder-img.png') }}" alt="error" id="error-img">
                <h1 id="error-title">Error @yield('status-code')</h1>
                <p id="error-msg">
                    @yield('error-msg')
                </p>
            </div>
